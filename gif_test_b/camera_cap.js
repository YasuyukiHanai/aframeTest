  ...
  function ready() {
    document.getElementById("capture").onclick = function() {
          var scene = document.getElementById('ghost');
...
function render(){
  ...
  if (video.offsetWidth > video.offsetHeight) {
      ...
      context.drawImage(scene, marginLeft+(scaledWidth*.25), 0, (scaledWidth*.5), height);
  }
  ...
  capturer.save(
    function(blob){
      ...
      reader.addEventListener("load", function () {
        gifler('002.gif').frames('canvas.ghost', onDrawFrame);
